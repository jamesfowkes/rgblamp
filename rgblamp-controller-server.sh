...
### BEGIN INIT INFO
# Provides:          rgblamp-controller-server
# Required-Start:    $remote_fs $syslog
# Required-Stop:     $remote_fs $syslog
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: RGB lamp controller server
# Description:       Python Flask API for LED control
### END INIT INFO

# Change the next 3 lines to suit where you install your script and what you want to call it
DIR=/home/pi/rgblamp/lamp-controller
DAEMON=$DIR/run.py
DAEMON_NAME=rgblamp-controller-server
LOGFILE=/var/log/rgblamp/controller.log

# Source configuration options
[ -f /etc/default/rgblamp/config ] && . /etc/default/rgblamp/config

# Add any command line options for your daemon here
DAEMON_OPTS="$LOGFILE /dev/ttyAMA0 --public"
