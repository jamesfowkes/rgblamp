...
### BEGIN INIT INFO
# Provides:          rgblamp-button-server
# Required-Start:    $remote_fs $syslog
# Required-Stop:     $remote_fs $syslog
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: RGB lamp button server
# Description:       Python socket interface to captouch buttons
### END INIT INFO

# Change the next 3 lines to suit where you install your script and what you want to call it
DIR=/home/pi/rgblamp/button-reader
DAEMON=$DIR/run.py
DAEMON_NAME=rgblamp-button-server
LOGFILE=/var/log/rgblamp/button-server.log
